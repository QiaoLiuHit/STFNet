...
class Backbone(BackboneBase):
    ...
    def __init__(self,
                 ...
                 pretrained,
                 frozen_layers):
        backbone = backbones.resnet18(output_layers=output_layers, pretrained=pretrained,
...
def build_backbone(settings, backbone_pretrained=False, frozen_backbone_layers=()):
